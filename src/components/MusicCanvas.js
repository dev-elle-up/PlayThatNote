...
let testValue = "67,10"
  return (
    <div >
      ...
      <rect width="100%" height="100%" fill="#EDC" stroke="green"/>

       <g id="staff" transform="">
          <path d="M 1.5,15 V 95" id="staff-line-left-vertical" fill="green" fillOpacity="0.75"   stroke="black" strokeWidth="3pt" />
          <path d="M 278,15 V 95" id="staff-line-right-vertical-1" fill="green" fillOpacity="0.75"   stroke="black" strokeWidth="3pt" />
          <path d="M 295,14 V 95" id="staff-line-right-vertical-2" fill="green" fillOpacity="0.75"   stroke="black" strokeWidth="8pt" />
          <path d="M 0,15 H 300" id="staff-line-5-A" fill="black" fillOpacity="0.75"   stroke="black" strokeWidth="1.4pt" />
          <path d="M 0,35 H 300" id="staff-line-4-F" fill="black" fillOpacity="0.75"   stroke="black" strokeWidth="1.4pt" />
          <path d="M 0,55 H 300" id="staff-line-3-D" fill="black" fillOpacity="0.75"  stroke="black" strokeWidth="1.4pt" />
          <path d="M 0,75 H 300" id="staff-line-2-B" fill="black" fillOpacity="0.75"   stroke="black" strokeWidth="1.4pt" />
          <path d="M 0,95 H 300" id="staff-line-1-G" fill="black" fillOpacity="0.75"   stroke="black" strokeWidth="1.4pt" />
        </g>
