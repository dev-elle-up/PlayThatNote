...
function MusicCanvas(props) {
  ...
  const hiddenElementYcoord = -50;
  const upArrowOpacity = props.upArrowOpacity;
  const downArrowOpacity = props.downArrowOpacity;
  ...
  let heightOnStaffUserNote = hiddenElementYcoord;
  let heightOnStaffPromptedNote = hiddenElementYcoord;
  ...
  let heightOnStaffPromptedSharp = hiddenElementYcoord;
  ...
  let heightOnStaffUserSharp = hiddenElementYcoord;
  ...
  let heightOnStaffPromptedFlat = hiddenElementYcoord;
  ...
  let heightOnStaffUserFlat = hiddenElementYcoord;
  ...
  let oldHeightOnStaffUpArrow = heightOnStaffUpArrow;
  let oldHeightOnStaffDownArrow = heightOnStaffDownArrow;
  if (props.oldUserNote){
    oldHeightOnStaffUpArrow = bassClefPianokeyToYcoord[props.oldUserNote.noteNum]-16;
    oldHeightOnStaffDownArrow = oldHeightOnStaffUpArrow;
  }
  ...
  return (
    <div className="bass-clef-and-staff">
      ...
      <rect width="100%" height="100%" fill="#EDC" fillOpacity="0" strokeOpacity="0.0" stroke="green"/>
       ...
       <g transform={`scale(${scaleForWholeNoteSvg})`} className="simpleAnimation">
        <path fill="#000000" stroke="black" strokeWidth="0.5pt" id="prompted-note" className="simpleAnimation"
       ...
       <g transform={`translate(118,${heightOnStaffPromptedSharp - sharpHeightOffset}) `} id="prompted-sharp" className="simpleAnimation">
         <path fill="#000000" stroke="black" strokeWidth="0.5pt" className="simpleAnimation"
       ...
       <g transform={`translate(120,${heightOnStaffPromptedFlat - flatHeightOffset})`} id="prompted-flat" className="simpleAnimation">
         <path fill="#000000" stroke="black" strokeWidth="0.5pt" className="simpleAnimation"
...
// from={`200 ${oldHeightOnStaffDownArrow}`}
// to={`200 ${heightOnStaffDownArrow}`}
...
MusicCanvas.propTypes = {
  ...
  oldUserNote:PropTypes.object,
  currentPromptedNote: PropTypes.object,
  noteColorFeedback: PropTypes.string,
  noteOpacityFeedback: PropTypes.string,
  upArrowOpacity: PropTypes.number,
  downArrowOpacity: PropTypes.number,
  }
